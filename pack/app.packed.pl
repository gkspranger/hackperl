...
$fatpacked{"CMD/Colors.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CMD_COLORS';
  package CMD::Colors;
...
$fatpacked{"odern/Perl.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'ODERN_PERL';
  package odern::Perl;
...
$fatpacked{"perl5/CMD/Colors.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'PERL5_CMD_COLORS';
  package CMD::Colors;
...
$fatpacked{"perl5/Modern/Perl.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'PERL5_MODERN_PERL';
  package Modern::Perl;
  # ABSTRACT: enable all of the features of Modern Perl with one import
  $Modern::Perl::VERSION = '1.20230106';
  use 5.010_000;
...
$fatpacked{"perl5/odern/Perl.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'PERL5_ODERN_PERL';
  package odern::Perl;
  #ABSTRACT: Module for enabling all of the features of Modern Perl
  $odern::Perl::VERSION = '1.20230106';
  use Modern::Perl;
